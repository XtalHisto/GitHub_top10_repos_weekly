...
# 发件人邮箱地址和密码
sender_email = '#########'  # 这里替换为您自己的发件人邮箱地址
sender_password = '########'  # 这里是你的授权码？ 非邮箱登录密码
...
message['From'] = Header('小号 <{}>'.format(sender_email), 'utf-8')  # 设置发件人昵称
message['To'] = Header('大号 <{}>'.format(recipient_email), 'utf-8')  # 设置收件人昵称
